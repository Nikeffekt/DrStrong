...
/* ============================================================
   ...
   KONVENTION (Stand v3): Bindestriche überall.
   - Dateinamen: vitamin-d3.json, whey-protein.json
   - Keys in wirkstoffe-wissen.json: 'vitamin-d3', 'whey-protein'
   - Code-Zugriff: WIRKSTOFFE_WISSEN['vitamin-d3'] (Bracket-Notation)
...
REIHENFOLGE.forEach((id) => {
  if (wirkstoffe[id]) {
    zusammengefuehrt[id] = wirkstoffe[id];
    verwendetIds.add(id);
  } else {
